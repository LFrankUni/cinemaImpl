...
public class Available extends TicketState implements java.io.Serializable, IAvailable {
	...
	private Available(Integer id, Ticket ticket, boolean objectOnly) throws ConstraintViolation, PersistenceException {
	 ...
	 * to its Cache!
	 */
	public static Available createAlreadyPersistent(AvailableProxy proxy, Ticket ticket)
	...
	public static Available createFresh(Ticket ticket) throws ConstraintViolation, PersistenceException {
		...
		try {
			dmlExecuter.insertInto("TicketAction", "id, typeKey", id.toString() + ", "
					+ TypeKeyManager.getTheInstance().getTypeKey("CinemaService", "Available").toString());
