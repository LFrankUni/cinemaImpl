...
public class seatsSupervisor
{
   //30 ===== GENERATED:      Attribute Section ======
   private static seatsSupervisor theInstance = new seatsSupervisor();
   private Relation<IAbstractRow,ISeat> elements;
   //40 ===== Editable : Your Attribute Section ======
   
   //50 ===== GENERATED:      Constructor ============
   public seatsSupervisor(){
      this.elements = new Relation<>("seats");
   }
   //60 ===== Editable : Your Constructors ===========
   
   //70 ===== GENERATED:      Feature Access =========
   public static seatsSupervisor getInstance(){return theInstance;}
