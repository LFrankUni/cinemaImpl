...
public class Seat extends Observable implements java.io.Serializable, ISeat
{
   ...
   throws PersistenceException{
      ...
      try{seatsSupervisor.getInstance().add(row,this);}catch(ConstraintViolation cv){}// Ok, because consistency is guaranteed with this statement
   }
   ...
   public AbstractRow getRow() throws PersistenceException{
      return seatsSupervisor.getInstance().getRow(this).getTheObject();
   }
